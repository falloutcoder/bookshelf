    ...
    return (
      <div className="list-books">
          ...
          <div>
            <BookShelf
              books={this.props.books.filter(
                book => book.shelf === SHELVES.currentlyReading,
              )}
            ...
            <BookShelf
              books={this.props.books.filter(
                book => book.shelf === SHELVES.wantToRead,
              )}
        ...
        <div className="open-search">
          <Link to="/search" onClick={this.props.switchOffSelectMode}>
            Add a book
          </Link>
        </div>
      </div>
